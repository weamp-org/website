...
// When adding a project, also update:
//   1. src/app/work/page.tsx — full article with its own anchor id
//   2. src/app/work/page.tsx metadata description (project names)
const projects = [
  {
    name: "Menim",
    slug: "menim",
